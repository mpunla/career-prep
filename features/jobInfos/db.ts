...
import { revalidateJobInfoCache } from "@/features/jobInfos/dbCache";
...
export async function insertJobInfo(jobInfo: typeof JobInfoTable.$inferInsert) {
  ...
  revalidateJobInfoCache(newJobInfo.id, newJobInfo.userId);
...
export async function updateJobInfo(
  ...
  revalidateJobInfoCache(updatedJobInfo.id, updatedJobInfo.userId);
